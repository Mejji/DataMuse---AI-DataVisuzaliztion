...
export function StoryBuilder() {
  ...
  return (
    <main className="flex-1 overflow-auto bg-mesh-warm">
      {/* Header */}
      <div className="sticky top-0 bg-white/80 backdrop-blur-md border-b border-border/60 px-6 py-4 flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-display font-bold text-dm-slate">Story Builder</h1>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-dm-coral to-dm-amber text-white rounded-xl
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        {!story && !isGenerating && (
          <div className="text-center py-20 animate-fade-up">
            ...
            <h2 className="text-2xl font-display font-bold text-dm-slate mb-3">
            ...
            {pinnedInsights.length > 0 && (
              <p className="text-xs font-medium text-dm-violet bg-violet-50 inline-block px-3 py-1.5 rounded-full mb-6">
        ...
        {isGenerating && (
          <div className="text-center py-20 animate-fade-in">
            ...
            <p className="text-dm-slate font-display font-semibold">Muse is crafting your data story...</p>
        ...
        {story && !isGenerating && (
          <div className="space-y-8 animate-fade-up">
            ...
            <input
              ...
              className="w-full text-3xl font-display font-extrabold text-dm-slate bg-transparent border-none
